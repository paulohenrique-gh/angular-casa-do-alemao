...
export const galleryImages: GalleryImage[] = [
  ...
  {
    imageUrl:
      'https://images.pexels.com/photos/547494/pexels-photo-547494.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: '',
  },
  {
    imageUrl:
      'https://images.pexels.com/photos/1119972/pexels-photo-1119972.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: '',
  },
  {
    imageUrl:
      'https://images.pexels.com/photos/756688/pexels-photo-756688.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: '',
  },
  {
    imageUrl:
  ...
  {
    imageUrl:
      'https://images.pexels.com/photos/161849/cologne-dom-night-architecture-161849.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: '',
  },
  {
    imageUrl:
      'https://images.pexels.com/photos/532864/pexels-photo-532864.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: '',
  },
  {
    imageUrl:
  ...
  {
    imageUrl:
      'https://images.pexels.com/photos/970763/pexels-photo-970763.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: '',
  },
  {
    imageUrl:
      'https://images.pexels.com/photos/1128408/pexels-photo-1128408.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: '',
  },
];
...
export const articles: Article[] = [
  ...
  },
  {
    ...
    previewText:
      'Explore os destinos turísticos mais populares da Alemanha, de cidades históricas a paisagens deslumbrantes.',
    content:
      'A Alemanha é um destino turístico fascinante, oferecendo uma mistura de cidades históricas, castelos medievais e paisagens naturais impressionantes. \n\nCidades como Berlim, Munique e Hamburgo são conhecidas por sua vibrante vida cultural, enquanto as regiões de Baviera e a Floresta Negra atraem turistas em busca de paisagens pitorescas. \n\nAlém disso, atrações como o Castelo de Neuschwanstein e o Vale do Reno são destinos imperdíveis para quem visita o país.',
  ...
  },
  {
    ...
    previewText:
      'Saiba mais sobre a renomada indústria automotiva da Alemanha, líder mundial no setor.',
    content:
      'A Alemanha é um dos principais produtores de automóveis do mundo, sendo a casa de marcas icônicas como Volkswagen, Mercedes-Benz, BMW e Audi. \n\nA qualidade e a inovação dos carros alemães são reconhecidas globalmente, e o setor automotivo desempenha um papel vital na economia do país. \n\nA Alemanha também lidera o caminho na transição para veículos elétricos e sustentáveis, com um forte foco em tecnologia e desenvolvimento de ponta.',
  ...
  },
  {
    ...
    previewText:
      'Conheça o sistema educacional alemão, um dos mais respeitados do mundo.',
    content:
      'A Alemanha possui um sistema educacional de alta qualidade, que atrai estudantes de todo o mundo. \n\nCom universidades renomadas e uma forte ênfase em pesquisa e inovação, o país oferece uma educação acessível e de excelência. \n\nAlém disso, o sistema de educação vocacional, que combina aprendizado teórico com experiência prática, é um modelo seguido por muitos países. \n\nAs universidades alemãs, como a Universidade de Heidelberg e a Universidade Técnica de Munique, estão entre as melhores do mundo.',
    publicationDate: new Date('2023-09-25'),
    user: {
      username: 'Clara Braun',
      role: 'editor',
    },
  },
];
